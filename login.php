...
<style>
        :root {
        --primary-color: rgb(67, 71, 70);
        --secondary-color: rgb(54, 59, 57);
        --black: #000000;
        --white: #ffffff;
        --gray: #efefef;
        --gray-2: #757575;
		...
		<div class="row">
			...
			<div class="col align-items-center flex-col sign-up">
                <div class="form-wrapper align-items-center">
                    <form class="form sign-up" action="signup.php" method="POST" onsubmit="return validateForm()">
			...
			<div class="col align-items-center flex-col sign-in">
				<div class="form-wrapper align-items-center">
					<form class="form sign-in" action="signin.php" method="POST">
						<div class="input-group">
