            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about__pic">
                        <img src="images/aboutus/<?php echo $row['image1']; ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="about__item">
                        <h4>Who We Are ?</h4>
                        <p><?php echo isset($row["P1"])?$row["P1"]:""; ?></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="about__item">
                        <h4>Who We Do ?</h4>
                        <p><?php echo isset($row["P2"])?$row["P2"]:""; ?></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="about__item">
                        <h4>Why Choose Us</h4>
                        <p><?php echo isset($row["P3"])?$row["P3"]:""; ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="testimonial">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 p-0">
                    <div class="testimonial__pic set-bg" data-setbg="images/aboutus/<?php echo $row['image2']; ?>"></div>
                </div>
            </div>
        </div>
    </section>
